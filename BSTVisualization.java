...
public class BSTVisualization extends JFrame implements ActionListener, KeyListener {
	...
	private void initialize() {
		...
		labelHeight.setFont(new Font("Monospaced", Font.BOLD, 20));
		topLeftPanel.add(labelHeight);

		// Height of BST answer
		ansHeight = new JLabel("0");
		ansHeight.setFont(new Font("Monospaced", Font.BOLD, 20));
		...
		// btnAdd.setBounds(size.width - 130,MonospacedMonospaced 20, 100, 30);
		...
		labelInorder.setFont(new Font("Monospaced", Font.BOLD, 20));
		...
		ansInorder.setFont(new Font("Monospaced", Font.PLAIN, 18));
		...
		labelPreorder.setFont(new Font("Monospaced", Font.BOLD, 20));
		...
		ansPreorder.setFont(new Font("Monospaced", Font.PLAIN, 18));
		...
		labelPostorder.setFont(new Font("Monospaced", Font.BOLD, 20));
		infoPanel.add(labelPostorder);

		// Postorder traversal answer
		ansPostorder = new JLabel("BST is empty.");
		ansPostorder.setFont(new Font("Monospaced", Font.PLAIN, 18));
	...
	public void add(int info) {
		...
		if (root == null) {
			...
			while (curr != null) {
				...
				if (info == currData) {
					JOptionPane.showMessageDialog(null, info + " already exist in the tree.");
					return;
